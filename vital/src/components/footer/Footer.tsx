...
function Footer() {
  ...
  return (
    <footer className="flex flex-col bg-grey-1">
      <div className="justify-items-start md:grid grid-cols-3 md:justify-items-center py-16 px-6">
        <div className="flex flex-col gap-y-3">
          ...
          <div className="mb-4 md:mb-0">
            ...
            <div className="flex gap-3">
              <a href="https://linktr.ee/projetointegradorvitalplus" target="blank">
                <LinkedinLogo size={30} color="#437228" />
              </a>
              <a href="https://linktr.ee/projetointegradorvitalplus" target="blank">
